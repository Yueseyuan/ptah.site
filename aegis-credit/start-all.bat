...
start "Aegis Backend" cmd /k "set DEV_NO_AUTH=True && cd /d C:\Users\origi\ptah.site\ptah.site\aegis-credit\backend && uvicorn app.main:app --host 0.0.0.0 --port 8082 --reload"
